		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#simplecalculator1simplecalculatorproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"simplecalculator1simplecalculatorproject-display": {
								"semanticObject": "simplecalculator1simplecalculatorproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=simplecalculator1.simplecalculatorproject",
									"url": sap.ui.require.toUrl("simplecalculator1/simplecalculatorproject")
								}
							}
						}
					}
